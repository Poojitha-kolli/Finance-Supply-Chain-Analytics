...
Finance &amp; Supply Chain Analytics project using MySQL to analyze sales performance, market trends, and forecast accuracy. Provides data-driven insights to optimize revenue, inventory management, and overall business operations.

---

## Objective
To leverage MySQL for analyzing AtliQ Hardware’s financial and supply chain data, deriving actionable insights into sales trends, top-performing markets, customer contributions, and forecast accuracy. The objective is to support data-driven decision-making, enhance financial planning, and improve overall supply chain efficiency.
